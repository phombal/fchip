...
const ObygnMap = () => {
    ...
    const providers = provider_json["Section"][2]["County"]["City"]
        ...
        providers.forEach(provider => {
            ...
            if (Array.isArray(groupValue)) {
                ...
                groupValue.forEach(item => {
                    ...
                    console.log("This is the physicianDetails: ", physicianDetails)
                    if (physicianDetails) {
                ...
                const physicianDetails = groupValue.PhysicianDetails;
                if (physicianDetails) {
                    if (Array.isArray(physicianDetails)) {
                        physicianDetails.forEach(detail => {
                            if (detail) {
